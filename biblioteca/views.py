...
from .serializer import Nacionalidad_Serializer, Autor_Serializer, Comuna_Serializer, Direccion_Serializer, Biblioteca_Serializer, Lector_Serializer, TipoCategoria_Serializer, Categoria_Serializer, Libro_Serializer, Prestamo_Serializer
